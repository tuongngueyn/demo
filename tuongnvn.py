...
"}")
        ...
        row=0
        for i in Values:
                self.tableWidget_3.setItem(row,0, QtWidgets.QTableWidgetItem(str(i[0])))
                self.tableWidget_3.setItem(row,1, QtWidgets.QTableWidgetItem(str(i[1])))
                self.tableWidget_3.setItem(row,2, QtWidgets.QTableWidgetItem(str(i[2])))
                self.tableWidget_3.setItem(row,3, QtWidgets.QTableWidgetItem(str(i[3])))
                self.tableWidget_3.setItem(row,4, QtWidgets.QTableWidgetItem(str(i[4])))
